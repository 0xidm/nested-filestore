...
def test_filestore_resolve(filestore):
    assert filestore.resolve(12) == "/tmp/filestore/000/000/12.bin"
    assert filestore.resolve(123) == "/tmp/filestore/000/000/123.bin"
    assert filestore.resolve(1234) == "/tmp/filestore/000/001/1234.bin"
    assert filestore.resolve(12345) == "/tmp/filestore/000/012/12345.bin"
    assert filestore.resolve(123456) == "/tmp/filestore/000/123/123456.bin"
    assert filestore.resolve(1234567) == "/tmp/filestore/001/234/1234567.bin"
    assert filestore.resolve(12345678) == "/tmp/filestore/012/345/12345678.bin"
    assert filestore.resolve(123456789) == "/tmp/filestore/123/456/123456789.bin"
